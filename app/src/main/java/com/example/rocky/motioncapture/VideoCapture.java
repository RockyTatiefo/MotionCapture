...
//                                    i++;
//                                Log.d("FRAME_CAPTURE", String.valueOf(i));
//                                } catch (Exception e){
...
//                            Log.d("FRAME_CAPTURE", frameQueue.size() + " frames captured in " + timeSpent/1000 + " seconds");
//                            Toast.makeText(VideoCapture.this, frameQueue.size() + " frames captured in " + timeSpent/1000  + " seconds", Toast.LENGTH_LONG).show();
//                            Log.d("FRAME_CAPTURE", String.valueOf(i));
//                            Toast.makeText(VideoCapture.this, String.valueOf(i), Toast.LENGTH_LONG).show();
//                        }
//                    }
//                }
//            });
...
//                Log.d("FRAME_CAPTURE", "Frame Captured.");
//            }
//        };
//    }
//
...
//                //might not be needed
//                try {
//                    mCamera.takePicture(shutterCallback(), rawDataCallback(), postViewCallback());
//                } catch (Exception e) {
